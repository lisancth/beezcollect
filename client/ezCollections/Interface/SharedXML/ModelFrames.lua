...
local ModelSettings = {
	...
	-- =========================================================================
	-- 修复：补充本服所有魔改种族的模型设置(原表只有WotLK 10族)。缺失会导致 settings=nil 每帧崩溃。
	-- key = UnitRace() 返回的 ClientFilestring + Male/Female (来源: 服务器 ChrRaces.dbc)
	-- 参数按体型相近的原版种族套用；SelectSettings 末尾另有 HumanMale 兜底作双保险。
	-- =========================================================================
	-- 地精(科赞) — 体型近侏儒
	["GoblinMale"    ] = { panMaxLeft = -0.3, panMaxRight = 0.3, panMaxTop = 0.40, panMaxBottom = -0.16, panValue = 52, zoomMultiplier = 1.8 },
	["GoblinFemale"  ] = { panMaxLeft = -0.3, panMaxRight = 0.3, panMaxTop = 0.40, panMaxBottom = -0.15, panValue = 60, zoomMultiplier = 1.5 },
	-- 狼人 — 体型近巨魔/高大
	["WorgenMale"    ] = { panMaxLeft = -0.5, panMaxRight = 0.6, panMaxTop = 0.90, panMaxBottom = -0.60, panValue = 30, zoomMultiplier = 3.8 },
	["WorgenFemale"  ] = { panMaxLeft = -0.4, panMaxRight = 0.4, panMaxTop = 0.85, panMaxBottom = -0.60, panValue = 33, zoomMultiplier = 3.5 },
	-- 熊猫人 — 体型近牛头人(矮胖)
	["PandarenMale"  ] = { panMaxLeft = -0.6, panMaxRight = 0.7, panMaxTop = 0.70, panMaxBottom = -0.50, panValue = 32, zoomMultiplier = 3.4 },
	["PandarenFemale"] = { panMaxLeft = -0.4, panMaxRight = 0.5, panMaxTop = 0.75, panMaxBottom = -0.45, panValue = 34, zoomMultiplier = 3.2 },
	-- 狐人 — 体型近侏儒/地精(矮小)
	["VulperaMale"   ] = { panMaxLeft = -0.3, panMaxRight = 0.3, panMaxTop = 0.40, panMaxBottom = -0.16, panValue = 52, zoomMultiplier = 1.9 },
	["VulperaFemale" ] = { panMaxLeft = -0.3, panMaxRight = 0.3, panMaxTop = 0.40, panMaxBottom = -0.15, panValue = 56, zoomMultiplier = 1.8 },
	-- 海象人 — 体型近牛头人(高大)
	["TuskarrMale"   ] = { panMaxLeft = -0.6, panMaxRight = 0.8, panMaxTop = 0.75, panMaxBottom = -0.45, panValue = 30, zoomMultiplier = 3.6 },
	["TuskarrFemale" ] = { panMaxLeft = -0.5, panMaxRight = 0.6, panMaxTop = 0.75, panMaxBottom = -0.45, panValue = 31, zoomMultiplier = 3.4 },
	-- 陶冉(牛头人变种)
	["TaunkaMale"    ] = { panMaxLeft = -0.7, panMaxRight = 0.9, panMaxTop = 0.75, panMaxBottom = -0.50, panValue = 31, zoomMultiplier = 4.0 },
	["TaunkaFemale"  ] = { panMaxLeft = -0.5, panMaxRight = 0.6, panMaxTop = 1.00, panMaxBottom = -0.30, panValue = 32, zoomMultiplier = 3.0 },
	-- 高等精灵 / 虚空精灵 — 体型近血精灵
	["HighelfMale"   ] = { panMaxLeft = -0.5, panMaxRight = 0.4, panMaxTop = 0.65, panMaxBottom = -0.80, panValue = 36, zoomMultiplier = 3.7 },
	["HighelfFemale" ] = { panMaxLeft = -0.3, panMaxRight = 0.2, panMaxTop = 0.65, panMaxBottom = -0.63, panValue = 38, zoomMultiplier = 3.0 },
	...
	["BrokenMale"    ] = { panMaxLeft = -0.6, panMaxRight = 0.6, panMaxTop = 0.95, panMaxBottom = -0.80, panValue = 28, zoomMultiplier = 4.3 },
	["BrokenFemale"  ] = { panMaxLeft = -0.3, panMaxRight = 0.3, panMaxTop = 0.80, panMaxBottom = -0.85, panValue = 31, zoomMultiplier = 3.8 },
	-- 邪兽人 — 体型近兽人
	["FelOrcMale"    ] = { panMaxLeft = -0.7, panMaxRight = 0.8, panMaxTop = 0.75, panMaxBottom = -0.60, panValue = 30, zoomMultiplier = 3.0 },
	["FelOrcFemale"  ] = { panMaxLeft = -0.4, panMaxRight = 0.3, panMaxTop = 0.80, panMaxBottom = -0.60, panValue = 37, zoomMultiplier = 3.0 },
	-- 纳迦 — 体型近夜精灵(高大)
	["NagaMale"      ] = { panMaxLeft = -0.5, panMaxRight = 0.5, panMaxTop = 0.85, panMaxBottom = -0.85, panValue = 30, zoomMultiplier = 4.2 },
	["NagaFemale"    ] = { panMaxLeft = -0.4, panMaxRight = 0.4, panMaxTop = 0.90, panMaxBottom = -0.75, panValue = 33, zoomMultiplier = 4.0 },
	-- 赞达拉巨魔 / 森林巨魔 / 冰霜巨魔 — 体型近巨魔
	["ZandalariMale" ] = { panMaxLeft = -0.5, panMaxRight = 0.6, panMaxTop = 1.05, panMaxBottom = -0.45, panValue = 27, zoomMultiplier = 3.7 },
	["ZandalariFemale"] = { panMaxLeft = -0.4, panMaxRight = 0.4, panMaxTop = 1.10, panMaxBottom = -0.60, panValue = 31, zoomMultiplier = 3.8 },
	["ForestTrollMale"] = { panMaxLeft = -0.5, panMaxRight = 0.6, panMaxTop = 1.05, panMaxBottom = -0.45, panValue = 27, zoomMultiplier = 3.7 },
	["ForestTrollFemale"] = { panMaxLeft = -0.4, panMaxRight = 0.4, panMaxTop = 1.10, panMaxBottom = -0.60, panValue = 31, zoomMultiplier = 3.8 },
	["IceTrollMale"  ] = { panMaxLeft = -0.5, panMaxRight = 0.6, panMaxTop = 1.05, panMaxBottom = -0.45, panValue = 27, zoomMultiplier = 3.7 },
	["IceTrollFemale"] = { panMaxLeft = -0.4, panMaxRight = 0.4, panMaxTop = 1.10, panMaxBottom = -0.60, panValue = 31, zoomMultiplier = 3.8 },
	-- 维库 — 体型近人类放大(高大)
	["VrykulMale"    ] = { panMaxLeft = -0.5, panMaxRight = 0.5, panMaxTop = 0.80, panMaxBottom = -0.70, panValue = 30, zoomMultiplier = 4.0 },
	["VrykulFemale"  ] = { panMaxLeft = -0.4, panMaxRight = 0.4, panMaxTop = 0.80, panMaxBottom = -0.65, panValue = 32, zoomMultiplier = 3.8 },
};
local function SelectSettings(model)
	...
	-- 修复：未知种族(魔改种族)回退到 HumanMale，确保永不返回 nil，防止 settings=nil 每帧崩溃
	return ModelSettings[playerRaceSex] or ModelSettings["HumanMale"];
end
...
function Model_OnLoad(self, maxZoom, minZoom, defaultRotation, onMouseUp)
	...
	-- 修复：settings 兜底，防魔改种族查表失败崩溃
	self.portraitZoomMultiplier = (self.settings and self.settings.zoomMultiplier) or 3.0;
	self.minZoom = (self.settings and self.settings.minZoom) or self.minZoom;
...
function Model_OnUpdate(self, elapsedTime, rotationsPerSecond)
	...
	if ezCollections.Config.Wardrobe.CameraOption ~= self.cameraOption then
		self.settings = SelectSettings(self);
		-- 修复：双保险，settings 异常时给默认 zoomMultiplier，防止每帧崩溃
		self.portraitZoomMultiplier = (self.settings and self.settings.zoomMultiplier) or 3.0;
		self.minZoom = (self.settings and self.settings.minZoom) or self.minZoom;
	end
...
function Model_Reset(self)
	-- 修复：SetPortraitZoom/SetRotation 由 Model_OnLoad 动态挂载，若 Reset 早于 OnLoad 触发则为 nil，整体早退防崩
	if not (self.SetRotation and self.SetPortraitZoom) then return end
	self.rotation = self.defaultRotation;
	self:SetRotation(self.rotation);
...
function GetUICameraInfo(cameraID)
	...
	-- 修复：cameraID 不在缓存(如套装预览相机)时返回值全为 nil，给默认值，避免各调用点算术崩溃(一处治本)
	posX = posX or 0;
	posY = posY or 0;
	posZ = posZ or 0;
	yaw = yaw or 0;
